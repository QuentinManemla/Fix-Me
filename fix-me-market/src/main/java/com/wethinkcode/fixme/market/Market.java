...
public class Market {
    ...
    public static void main(String[] args) throws Exception {
        marketInstruments.add(new Instrument(1, "Simple Bond", 10, 50));
        marketInstruments.add(new Instrument(2, "Treasury Bill", 10, 40));
        marketInstruments.add(new Instrument(3, "Equity Loan", 10, 60));
        marketInstruments.add(new Instrument(4, "Tracker-Certificate", 10, 80));
        Connect();
    }
    ...
    private static void Connect()  {
        try {
            ...
            InstrumentController.viewInstruements(marketInstruments, true);
